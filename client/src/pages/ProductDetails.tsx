        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2 mb-8">
              ...
              <Link href={`/vendor/${encodeURIComponent(product.vendor)}`} className="text-primary font-semibold hover:underline">
                {product.vendor}
              </Link>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12 pb-12 border-b border-border">
              ...
              >
                <Heart className="w-6 h-6" fill={isWishlisted ? "currentColor" : "none"} className={isWishlisted ? "text-secondary" : ""} />
              </Button>
            </div>
