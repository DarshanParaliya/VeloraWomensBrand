    ...
    <section className="py-24 bg-neutral-50">
      <Container>
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 px-4">
          ...
          <Link href="/shop" className="text-[10px] uppercase tracking-[0.3em] font-semibold border-b border-black pb-1 hover:text-neutral-500 hover:border-neutral-500 transition-all">
            Discover All
          </Link>
        </div>
