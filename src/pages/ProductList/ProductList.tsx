...
export const ProductList: React.FC = () => {
  ...
  return (
    <main className="min-h-screen bg-white pb-32">
      ...
      <Container>
        {/* Toolbar */}
        <div className="flex flex-col md:flex-row justify-between items-center py-12 border-b border-neutral-100 mb-12 gap-8 sticky top-20 bg-white/80 backdrop-blur-md z-30 px-2 mt-[-2px]">
            ...
            <div className="flex items-center gap-8">
                <div className="relative group">
                    ...
                    <div className="absolute top-full right-0 mt-4 w-56 bg-white border border-neutral-100 shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
        ...
        {isFilterOpen && (
          <div className="mb-12 animate-in fade-in slide-in-from-top-4 duration-500">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-8 border-b border-neutral-100">
                ...
                <div className="flex flex-col gap-4">
                  {categories.map(category => (
                    <button
                      ...
                      className={`text-left text-[11px] tracking-[0.1em] uppercase transition-colors ${selectedCategory === category ? 'text-neutral-900 font-bold' : 'text-neutral-500 hover:text-neutral-900'}`}
                    >
                      {category}
                    </button>
                  ))}
                  <button
                    onClick={() => setSelectedCategory(null)}
                    className={`text-left text-[11px] tracking-[0.1em] uppercase transition-colors ${!selectedCategory ? 'text-neutral-900 font-bold' : 'text-neutral-500 hover:text-neutral-900'}`}
                  >
                    All Collections
                  </button>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  {/* Additional price filters could be added here */}
                </div>
              </div>
